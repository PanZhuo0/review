...
// Validate checks the field values on ReplyReviewResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *ReplyReviewResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ReplyReviewResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ReplyReviewResponseMultiError, or nil if none found.
func (m *ReplyReviewResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *ReplyReviewResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ReplyReviewResponseMultiError(errors)
	}

	return nil
}

// ReplyReviewResponseMultiError is an error wrapping multiple validation
// errors returned by ReplyReviewResponse.ValidateAll() if the designated
// constraints aren't met.
type ReplyReviewResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ReplyReviewResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ReplyReviewResponseMultiError) AllErrors() []error { return m }

// ReplyReviewResponseValidationError is the validation error returned by
// ReplyReviewResponse.Validate if the designated constraints aren't met.
type ReplyReviewResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ReplyReviewResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ReplyReviewResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ReplyReviewResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ReplyReviewResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ReplyReviewResponseValidationError) ErrorName() string {
	return "ReplyReviewResponseValidationError"
}

// Error satisfies the builtin error interface
func (e ReplyReviewResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sReplyReviewResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ReplyReviewResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ReplyReviewResponseValidationError{}
