...
func (c *businessClient) ReplyReview(ctx context.Context, in *ReplyReviewRequest, opts ...grpc.CallOption) (*ReplyReviewResponse, error) {
	out := new(ReplyReviewResponse)
	err := c.cc.Invoke(ctx, "/api.business.v1.Business/ReplyReview", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBusinessServer) ReplyReview(context.Context, *ReplyReviewRequest) (*ReplyReviewResponse, error) {
...
func _Business_ReplyReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.business.v1.Business/ReplyReview",
	}
